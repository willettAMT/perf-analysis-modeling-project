...
**Framework:** llama.cpp  
**Date:** Tue Dec  2 08:10:38 PM PST 2025
**Node:** orcaga19
**Nodes Used:** 1
**GPUs per Node:** 1
...
GPU Info:
NVIDIA A30, 24576 MiB, 580.105.08
...
| ------------------------------ | ---------: | ---------: | ---------- | ------: | --------------: | -------------------: |
| qwen3 8B Q5_K - Medium         |   5.44 GiB |     8.19 B | CUDA,BLAS  |      64 |           pp512 |          6.90 ± 0.14 |
| qwen3 8B Q5_K - Medium         |   5.44 GiB |     8.19 B | CUDA,BLAS  |      64 |           tg128 |         15.33 ± 0.66 |
...
| model                          |       size |     params | backend    | threads |            test |                  t/s |
| ------------------------------ | ---------: | ---------: | ---------- | ------: | --------------: | -------------------: |
| qwen3 8B Q5_K - Medium         |   5.44 GiB |     8.19 B | CUDA,BLAS  |      64 |           pp512 |          9.77 ± 0.08 |
| qwen3 8B Q5_K - Medium         |   5.44 GiB |     8.19 B | CUDA,BLAS  |      64 |           tg128 |         17.36 ± 2.30 |
...
| model                          |       size |     params | backend    | threads |            test |                  t/s |
| ------------------------------ | ---------: | ---------: | ---------- | ------: | --------------: | -------------------: |
| qwen3 8B Q5_K - Medium         |   5.44 GiB |     8.19 B | CUDA,BLAS  |      64 |           pp512 |       2421.79 ± 0.81 |
| qwen3 8B Q5_K - Medium         |   5.44 GiB |     8.19 B | CUDA,BLAS  |      64 |           tg128 |         75.83 ± 0.14 |
...
*Stored in: /home/aaronw/perf-analysis-modeling-project/measurements/aaron/benchmark_results_20251202_201038.md*
